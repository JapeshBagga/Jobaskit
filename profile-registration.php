        ...
        <div class="col-xl-12 order-xl-2">
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">REGISTERATION </h3>
                </div>
              ...
              <form action="" method="post">
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <textarea name="up_about" rows="4" class="form-control" placeholder="A few words about you ..."></textarea>
                  </div>
                </div>
				<div class="row">
					<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12"></div>
					<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
						<button type="submit" name="submit" class="btn btn-custon-rounded-three btn-primary">Submit</button>
					</div>
