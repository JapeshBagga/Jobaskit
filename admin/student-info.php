                ...
                <div class="col-lg-12 order-xl-1">
                    <form id="formvalue" class="form" method="POST" autocomplete="off">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                        <?php
                            $intro_query = "select name, intro_data,intro_comments from introduction inner join login on introduction.intro_login_id=login.login_id";
                            $intro_result = mysqli_query($conn, $intro_query);
                            while($intro_row = mysqli_fetch_assoc($intro_result)){
                        ?>
                        
                                <h5 class="h2 card-title mb-0"><?php echo $intro_row['name']; ?></h5>
                                <small class="text-muted">Joined on Oct 29th at 10:23 AM</small>
                                <p class="card-text mt-4">Introduction</p>     
                                <p><?php echo $intro_row['intro_data']; ?></p>    
                            </div>
                            </div> 
                        <?php
                            }
