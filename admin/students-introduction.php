  ...
  <div class="main-content" id="panel">
    ...
    <div class="container-fluid mt--6">
      <div class="row">
		...
		<?php
			$intro_query = "select up_fullname,up_image, intro_data,intro_comments from introduction inner join user_profile on introduction.intro_login_id=user_profile.up_login_id";
            ...
            <div class="card" style="height: 200px;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <a href="student-info.php?eid=<?php echo $intro_row['quiz_id'];?>">">
