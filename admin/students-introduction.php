...
<head>
  ...
  <title>Students-Introduction's | JoBaskit</title>
  ...
  <div class="main-content" id="panel">
         ...
         <div class="header-body">
           <div class="row align-items-center py-4">
             <div class="col-lg-6 col-7">
               <h6 class="h2 text-white d-inline-block mb-0">Students-Introduction's </h6>
             ...
             <div class="col-lg-6 col-5 text-right">
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                 <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                   ...
                   <!--<li class="breadcrumb-item active" aria-current="page">Students-Introduction's</li>-->
                 </ol>
               </nav>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
		...
		<?php
			$intro_query = "select up_fullname,up_image, intro_data,intro_comments,intro_login_id from introduction inner join user_profile on introduction.intro_login_id=user_profile.up_login_id";
			$intro_result = mysqli_query($conn, $intro_query);
			while($intro_row = mysqli_fetch_assoc($intro_result)){
		?>
          ...
          <div class="col-lg-4">
            <div class="card" style="height: 200px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4"><img alt="logo" style="width:76px; height:76px;" class="rounded-circle img-left img-fluid shadow shadow-lg--hover" src="../<?php echo $intro_row['up_image'];?>"></div>
                        <div class="col-lg-8">
                            <a href="student-info.php?id=<?php echo $intro_row['intro_login_id'];?>">
                                <h3><?php echo $intro_row['up_fullname'];?></h3>
                                <p class="card-text text-sm text-muted mb-1"><?php echo $intro_row['intro_data'];?></p>
                            </a>
