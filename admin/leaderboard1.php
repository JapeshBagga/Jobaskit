...
<head>
  ...
  <title>Leaderboard | JoBaskit</title>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link" href="aptitude-quiz.php">
                <i class="ni ni-bullet-list-67"></i>
                <span class="nav-link-text">Aptitude Quizes</span>
              </a>
        </div>
      </div>
    </div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Japesh</span>
                  </div>
                </div>
              </a>
          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">Leaderboard</h6>
                ...
                <table class="table align-items-center table-flush" id="datatable-basic">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col" class="sort" data-sort="budget">Total Score</th>
                      <th scope="col" class="sort" data-sort="status">Percentile</th>
                    </tr>
                  </thead>
                  <tbody class="list">
				  <?php
					$query_lead = "select score_login_id,sum(score_data),cast(avg(score_data) as decimal (12,2)),name from score inner join login on login_id=score_login_id group by score_login_id order by avg(score_data) desc";
					$query_lead_result = mysqli_query($conn, $query_lead);
					$i=1;
					while($row_lead = mysqli_fetch_assoc($query_lead_result)){
					
				?>
                    <tr>
						<td>
                        <div class="d-flex align-items-center">
                          <span class="completion mr-2"><?php echo $i;?></span>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <span class="completion mr-2"><?php echo $row_lead['name'];?></span>
                        </div>
                      </td>
                       <td>
                        <div class="d-flex align-items-center">
                          <span class="completion mr-2"><?php echo $row_lead['sum(score_data)'];?></span>
                        </div>
                      </td>
					  <td>
                        <div class="d-flex align-items-center">
                          <span class="completion mr-2"><?php echo $row_lead['cast(avg(score_data) as decimal (12,2))'];?></span>
                        </div>
                      </td>
                    </tr>
